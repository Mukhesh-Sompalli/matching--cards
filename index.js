...
const bikeImages = [
  "https://i0.wp.com/www.asphaltandrubber.com/wp-content/uploads/2016/07/2017-Yamaha-FZ-10-USA-35-scaled.jpg?fit=2560%2C1707&ssl=1",
  "https://cdn.pixabay.com/photo/2017/08/10/04/06/motorcycle-2610599_1280.jpg",
  "https://cdn.pixabay.com/photo/2016/11/23/14/53/bike-1850461_1280.jpg",
  "https://cdn.pixabay.com/photo/2020/04/22/19/58/motorcycle-5077845_1280.jpg",
  "https://cdn.pixabay.com/photo/2020/04/20/18/59/bike-5071192_1280.jpg",
  "https://cdn.pixabay.com/photo/2020/06/24/21/48/bike-5336984_1280.jpg",
  "https://cdn.pixabay.com/photo/2017/01/11/14/27/motorcycle-1977528_1280.jpg",
  "https://cdn.pixabay.com/photo/2016/11/29/03/27/sport-bike-1869312_1280.jpg",
];
...
const startTimer = () => {
  ...
  timerInterval = setInterval(() => {
    ...
    // Alert when 15 seconds are left
    if (timer === 15) {
...
const setupGame = () => {
  ...
  const gameBoard = document.getElementById("game-board");
  gameBoard.innerHTML = "";
  gameBoard.classList.remove("medium-level", "difficult-level"); // Remove previous classes
  ...
  if (selectedLevel === "easy") {
    ...
    gameBoard.style.gridTemplateColumns = "repeat(4, 1fr)";
    gameBoard.style.gridTemplateRows = "repeat(3, 1fr)"; // Adjust rows to make it smaller
    gameBoard.classList.add("medium-level"); // Add medium level class
  } else if (selectedLevel === "difficult") {
    gameBoard.style.gridTemplateColumns = "repeat(4, 1fr)";
    gameBoard.style.gridTemplateRows = "repeat(4, 1fr)"; // Adjust rows for difficult level
    gameBoard.classList.add("difficult-level"); // Add difficult level class
  }
